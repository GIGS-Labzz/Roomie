...
VALUES
  ...
  (uid12, 'uche.ob  iechina@seed.roomie.ng',  extensions.crypt('Test@1234', extensions.gen_salt('bf', 10)), NOW(), 'authenticated', 'authenticated', NOW(), NOW(), '{"full_name":"Uche Obiechina", "avatar_url":"https://i.pravatar.cc/150?img=23"}'::jsonb, FALSE),
